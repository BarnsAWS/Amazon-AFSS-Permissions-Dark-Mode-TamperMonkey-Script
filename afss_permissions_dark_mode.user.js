// ==UserScript==
// @name         AFSS Permissions Dark Mode
// @namespace    http://tampermonkey.net/
// @version      1.3
// @description  High-contrast dark mode for prod.permissions.afss-security.aws.dev (Manage Permissions / Posix Group browser) — nuclear approach.
//               Color palette: AWS Cloudscape "Polaris Dark Mode" tokens v3.3.
// @author       BarnsAWS
// @match        https://prod.permissions.afss-security.aws.dev/*
// @match        https://*.permissions.afss-security.aws.dev/*
// @grant        GM_addStyle
...
(function() {
    ...
    const SCRIPT_NAME = 'AFSS Permissions Dark Mode';
    const STYLE_ID = 'afss-permissions-dark-mode-style';
